...
public class Genre implements Serializable {
    ...
    @OneToMany(mappedBy = "genreid")
    private Collection<TvShow> tvShowCollection;
    ...
    @XmlTransient
    public Collection<TvShow> getTvShowCollection() {
        return tvShowCollection;
    }

    public void setTvShowCollection(Collection<TvShow> tvShowCollection) {
